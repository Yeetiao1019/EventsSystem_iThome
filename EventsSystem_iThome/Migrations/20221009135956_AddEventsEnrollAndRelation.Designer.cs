...
namespace EventsSystem_iThome.Migrations
{
    ...
    [Migration("20221009135956_AddEventsEnrollAndRelation")]
    partial class AddEventsEnrollAndRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserEventsEnroll", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("EventsEnrollId")
                        .HasColumnType("int");

                    b.HasKey("ApplicationUserId", "EventsEnrollId");

                    b.HasIndex("EventsEnrollId");

                    b.ToTable("ApplicationUserEventsEnroll");
                });
            ...
            modelBuilder.Entity("EventsSystem_iThome.Models.EventsEnroll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationUserEventsEnroll", b =>
                {
                    ...
                    b.HasOne("EventsSystem_iThome.Models.EventsEnroll", null)
                        .WithMany()
                        .HasForeignKey("EventsEnrollId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
